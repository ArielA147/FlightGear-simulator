...
//void ConnectCommand::enterChar() {
//    cout << "enter any char in order to open the simulator connection" << endl;
//    cin.ignore();
//}
...
//
//    CreateConnect client_connection(params->sockfd, params->port);
